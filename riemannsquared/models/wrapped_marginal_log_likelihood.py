...
class WrappedMarginalLogLikelihood(ExactMarginalLogLikelihood):
    """
    ...
    def __init__(self, likelihood, model):
        super(WrappedMarginalLogLikelihood, self).__init__(likelihood, model)
    ...
    def forward(self, function_dist, target, *params, **kwargs):
        ...
        # Add change of variable term
        res = res.add(-self.model.metric.logdet(target))
